            ...
            'items' => array(
                ...
                array('label' => '<i class="fa fa-database"></i> <span>Master</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-group"></i> <span>Internal position</span>', 'url' => array('/site/masterinternalposition/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-bullseye"></i> <span>International Number</span>', 'url' => array('/site/masterinternationalnumber/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-file-image-o"></i> <span>Labels</span>', 'url' => array('/site/masterlabel/index'), 'visible' => '1', 'active' => '0'),
                        ...
                        array('label' => '<i class="fa fa-tty"></i> <span>Pseudonym Types</span>', 'url' => array('/site/masterpseudonymtypes/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-paypal"></i> <span>Payment Methods</span>', 'url' => array('/site/masterpaymentmethod/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-male"></i> <span>Profession</span>', 'url' => array('/site/masterprofession/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-building-o"></i> <span>Region</span>', 'url' => array('/site/masterregion/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-share-alt"></i> <span>Share Definition</span>', 'url' => array('/site/sharedefinitionperrole/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-rupee"></i> <span>Tariff</span>', 'url' => array('/site/mastertariff/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-list"></i> <span>Types</span>', 'url' => array('/site/mastertype/index'), 'visible' => '1', 'active' => '0'),
                        array('label' => '<i class="fa fa-desktop"></i> <span>Type (Places)</span>', 'url' => array('/site/masterplace/index'), 'visible' => '1', 'active' => '0'),
                ...
                array('label' => '<i class="fa fa-briefcase"></i> <span>Documentation</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        array('label' => '<i class="fa fa-group"></i> <span>Members</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                            ...
                            'submenuOptions' => array('class' => 'treeview-menu'),
                            'items' => array(
                                array('label' => '<i class="fa fa-book"></i> <span>Author</span>', 'url' => array('/site/authoraccount/index'), 'visible' => '1', 'active' => '0'),
                                array('label' => '<i class="fa fa-music"></i> <span>Performer</span>', 'url' => array('/site/performeraccount/index'), 'visible' => '1', 'active' => '0'),
                                array('label' => '<i class="fa fa-microphone"></i> <span>Publisher</span>', 'url' => array('/site/publisheraccount/index'), 'visible' => '1', 'active' => '0'),
                                array('label' => '<i class="fa fa-money"></i> <span>Producer</span>', 'url' => array('/site/produceraccount/index'), 'visible' => '1', 'active' => '0'),
                ...
                array('label' => '<i class="fa fa-copyright"></i> <span>Licensing</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-cny"></i> <span>Contract</span>', 'url' => array('/site/tariffcontracts/index'), 'visible' => 1, 'active' => 0),
