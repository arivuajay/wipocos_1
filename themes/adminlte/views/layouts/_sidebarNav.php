                    ...
                    'items' => array(
                        array('label' => '<i class="fa fa-group"></i> <span>Members</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                            ...
                            'items' => array(
                                ...
                                array('label' => '<i class="fa fa-book"></i> <span>Authors Group</span>', 'url' => array('/site/group/index/role/author')),
                                array('label' => '<i class="fa fa-music"></i> <span>Performers Group</span>', 'url' => array('/site/group/index/role/performer')),
                                array('label' => '<i class="fa fa-microphone"></i> <span>Publishers Group</span>', 'url' => array('/site/publishergroup/index/role/publisher')),
                                array('label' => '<i class="fa fa-money"></i> <span>Producers Group</span>', 'url' => array('/site/publishergroup/index/role/producer')),
                            ),
                        ),
...
//                    'submenuOptions' => array('class' => 'treeview-menu'),
//                    'items' => array(
//                        array('label' => '<i class="fa fa-book"></i> <span>Authors</span>', 'url' => array('/site/group/index/role/author')),
//                        array('label' => '<i class="fa fa-music"></i> <span>Performers</span>', 'url' => array('/site/group/index/role/performer')),
//                        array('label' => '<i class="fa fa-microphone"></i> <span>Publishers</span>', 'url' => array('/site/publishergroup/index/role/publisher')),
//                        array('label' => '<i class="fa fa-money"></i> <span>Producers</span>', 'url' => array('/site/publishergroup/index/role/producer')),
//                    ),
//                ),
