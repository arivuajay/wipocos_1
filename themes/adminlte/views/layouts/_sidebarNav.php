            ...
            'items' => array(
                ...
                array('label' => '<i class="fa fa-pie-chart"></i> <span>Distribution</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-calendar"></i> <span>Distribution Timetable</span>', 'url' => array('/site/distributionsetting/index'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-area-chart"></i> <span>Utilization Periods</span>', 'url' => array('/site/distributionutlizationperiod/index'), 'visible' => '1'),
//                        array('label' => '<i class="fa fa-bar-chart"></i> <span>Classes & Available Periods</span>', 'url' => array('/site/distributionlogsheet/availperiods'), 'visible' => '1'),
                ...
                array('label' => '<i class="fa fa-file-text"></i> <span>Reports</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'visible' => '1',
                    'items' => array(
                        array('label' => '<i class="fa fa-sliders"></i> <span>Works By Right Holder</span>', 'url' => array('/site/report/worksbyrh'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-volume-up"></i> <span>Recordings By Right Holder</span>', 'url' => array('/site/report/recsbyrh'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-users"></i> <span>Group member list</span>', 'url' => array('/site/report/grpmemlist'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-warning"></i> <span>Membership expiry list</span>', 'url' => array('/site/report/memberlist'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-newspaper-o"></i> <span>Logsheet List</span>', 'url' => array('/site/report/loglist'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-calendar"></i> <span>Distribution list</span>', 'url' => array('/site/report/distbyrh'), 'visible' => '1'),
                        array('label' => '<i class="fa fa-tty"></i> <span>Pseudonyms list</span>', 'url' => array('/site/report/pseudolist'), 'visible' => '1'),
                    ),
                ),
            ),
