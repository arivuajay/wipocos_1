            ...
            'items' => array(
                ...
                array('label' => '<i class="fa fa-briefcase"></i> <span>Documentation</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-group"></i> <span>Author Group</span>', 'url' => array('/site/group/index/role/author')),
                        array('label' => '<i class="fa fa-music"></i> <span>Performer</span>', 'url' => array('/site/performeraccount/index')),
                        array('label' => '<i class="fa fa-group"></i> <span>Performer Group</span>', 'url' => array('/site/group/index/role/performer')),
