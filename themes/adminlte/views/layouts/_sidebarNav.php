        ...
        $this->widget('application.components.MyMenu', array(
            ...
            'items' => array(
                ...
                array('label' => '<i class="fa fa-cog"></i> <span>Administration</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'visible' => '1',
                    'items' => array(
                        array('label' => '<i class="fa fa-weixin"></i> <span>Society</span>', 'url' => array('/site/society/index')),
                        array('label' => '<i class="fa fa-music"></i> <span>Roles</span>', 'url' => array('/site/masterrole/index')),
                        array('label' => '<i class="fa fa-user"></i> <span>Operator</span>', 'url' => array('/site/user/index')),
                    ),
                ),
                array('label' => '<i class="fa fa-database"></i> <span>Master</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-bank"></i> <span>Cities</span>', 'url' => array('/site/mastercity/index')),
                        array('label' => '<i class="fa fa-barcode"></i> <span>Code Definition</span>', 'url' => array('/site/internalcodegenerate/setup')),
                        array('label' => '<i class="fa fa-binoculars"></i> <span>Destination</span>', 'url' => array('/site/masterdestination/index')),
                        ...
                        array('label' => '<i class="fa fa-file-image-o"></i> <span>Labels</span>', 'url' => array('/site/masterlabel/index')),
                        ...
                        array('label' => '<i class="fa fa-cubes"></i> <span>Manufacturer</span>', 'url' => array('/site/mastermanufacturer/index')),
                        ...
                        array('label' => '<i class="fa fa-share-alt"></i> <span>Share Definition</span>', 'url' => array('/site/sharedefinitionperrole/index')),
                        array('label' => '<i class="fa fa-rupee"></i> <span>Tariff</span>', 'url' => array('/site/mastertariff/index')),
                        array('label' => '<i class="fa fa-list"></i> <span>Types</span>', 'url' => array('/site/mastertype/index')),
                        array('label' => '<i class="fa fa-desktop"></i> <span>Type (Places)</span>', 'url' => array('/site/masterplace/index')),
                        array('label' => '<i class="fa fa-newspaper-o"></i> <span>Types of events</span>', 'url' => array('/site/mastereventtype/index')),
                        array('label' => '<i class="fa fa-at"></i> <span>RightHolder Type</span>', 'url' => array('/site/mastertyperights/index')),
                        array('label' => '<i class="fa fa-video-camera"></i> <span>Studio</span>', 'url' => array('/site/masterstudio/index')),
                ...
                array('label' => '<i class="fa fa-briefcase"></i> <span>Documentation</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'items' => array(
                        ...
                        array('label' => '<i class="fa fa-headphones"></i> <span>Sound Carriers</span>', 'url' => array('/site/soundcarrier/index')),
                        array('label' => '<i class="fa fa-file-audio-o"></i> <span>Recording Session Sheets</span>', 'url' => array('/site/recordingsession/index')),
                ...
                array('label' => '<i class="fa fa-copyright"></i> <span>Licensing</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'visible' => '1',
                    'items' => array(
                        array('label' => '<i class="fa fa-user"></i> <span>Users & Customers</span>', 'url' => array('/site/customeruser/index')),
                        array('label' => '<i class="fa fa-shield"></i> <span>Inspectors</span>', 'url' => array('/site/inspector/index')),
                        array('label' => '<i class="fa fa-cny"></i> <span>Contract</span>', 'url' => array('/site/tariffcontracts/index')),
                        array('label' => '<i class="fa fa-file-text"></i> <span>Invoices</span>', 'url' => array('/site/contractinvoice/index')),
                        array('label' => '<i class="fa fa-envelope"></i> <span>Email Templates</span>', 'url' => array('/site/emailtemplate/index')),
                    ),
                ),
                array('label' => '<i class="fa fa-pie-chart"></i> <span>Distribution</span><i class="fa pull-right fa-angle-left"></i>', 'url' => '#',
                    ...
                    'visible' => '1',
                    'items' => array(
                        array('label' => '<i class="fa fa-puzzle-piece"></i> <span>Class</span>', 'url' => array('/site/distributionclass/index')),
                        array('label' => '<i class="fa fa-paw"></i> <span>Sub-Class</span>', 'url' => array('/site/distributionsubclass/index')),
                        array('label' => '<i class="fa fa-calendar"></i> <span>Setting Dates</span>', 'url' => array('/site/distributionsetting/index')),
                        array('label' => '<i class="fa fa-area-chart"></i> <span>Utlization Periods</span>', 'url' => array('/site/distributionutlizationperiod/index')),
                    ),
                ),
            ),
