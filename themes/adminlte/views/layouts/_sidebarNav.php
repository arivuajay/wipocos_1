...
//                array('label' => '<i class="fa fa-user"></i> <span>Users & Customers</span>', 'url' => '#'),
                ...
                array('label' => '<i class="fa fa-music"></i> <span>Author</span>', 'url' => array('/site/authoraccount/index')),
                array('label' => '<i class="fa fa-child"></i> <span>Performer</span>', 'url' => array('/site/performeraccount/index')),
