...
CREATE TABLE `wipo_internalcode_generate` (
  ...
  `Gen_User_Type` enum('A','P','G','O','PU','PR','PG','W') NOT NULL DEFAULT 'A' COMMENT 'A -> Author, P -> Performer, G -> Group, O -> Organization, PU -> Publisher, PR -> Producer, PG -> Publisher/producer group',
...
insert  into `wipo_internalcode_generate`(`Gen_Inter_Code_Id`,`Gen_User_Type`,`Gen_Prefix`,`Gen_Inter_Code`,`Gen_Suffix`) values (1,'A','A','1018',NULL),(2,'P','P','1005',NULL),(3,'G','G','1014',NULL),(4,'O','SOC','003',NULL),(5,'PU','E','109',NULL),(6,'PG','EG','108',NULL),(7,'PR','R','106',NULL),(8,'W','A','0000007',NULL);
...
CREATE TABLE `wipo_work` (
  ...
  `Work_Language_Id` int(11) NOT NULL,
  `Work_Internal_Code` varchar(100) NOT NULL,
  `Work_Iswc` varchar(100) NOT NULL,
  `Work_Wic_Code` varchar(100) NOT NULL,
...
insert  into `wipo_work`(`Work_Id`,`Work_Org_Title`,`Work_Language_Id`,`Work_Internal_Code`,`Work_Iswc`,`Work_Wic_Code`,`Work_Type_Id`,`Work_Factor_Id`,`Work_Instrumentation`,`Work_Duration`,`Work_Creation`,`Work_Opus_Number`,`Active`,`Created_Date`,`Rowversion`) values (2,'Music 1',5,'A0000001','89841515','895515415',1,1,'[\"11\"]','120:50:50',2015,NULL,'1','2015-05-13 19:05:04','0000-00-00 00:00:00'),(3,'Music 2',1,'A0000002','89841515','895515415',1,1,'','02:06:00',2015,NULL,'1','2015-05-13 19:09:28','0000-00-00 00:00:00'),(4,'Music 3',1,'A0000003','89841515','895515415',1,1,'','00:00:00',2015,NULL,'1','2015-05-14 18:00:19','0000-00-00 00:00:00'),(6,'Music 4',5,'A0000005','89841515','895515415',4,1,'','00:00:00',2015,NULL,'1','2015-05-16 14:12:51','0000-00-00 00:00:00'),(7,'Music 5',5,'A0000006','89841515','895515415',4,1,'[\"1\",\"2\"]','00:00:00',2015,NULL,'1','2015-05-19 11:30:08','0000-00-00 00:00:00');
...
CREATE TABLE `wipo_work_documentation` (
  ...
  `Work_Doc_File` varchar(255) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  ...
  CONSTRAINT `FK_wipo_work_documentation_document_type` FOREIGN KEY (`Work_Doc_Type_Id`) REFERENCES `wipo_master_document_type` (`Master_Doc_Type_Id`) ON UPDATE CASCADE,
...
insert  into `wipo_work_documentation`(`Work_Doc_Id`,`Work_Id`,`Work_Doc_Status_Id`,`Work_Doc_Inclusion`,`Work_Doc_Dispute`,`Work_Doc_Type_Id`,`Work_Doc_Sign_Date`,`Work_Doc_File`,`Created_Date`,`Rowversion`) values (1,2,1,'Y','Y',1,'2015-05-14','files','2015-05-14 19:33:18','0000-00-00 00:00:00'),(2,7,1,'N','N',1,'2015-05-20','files','2015-05-20 13:03:13','0000-00-00 00:00:00');
...
insert  into `wipo_work_rightholder`(`Work_Right_Id`,`Work_Id`,`Work_Member_Internal_Code`,`Work_Right_Role`,`Work_Right_Broad_Share`,`Work_Right_Broad_Special`,`Work_Right_Broad_Org_id`,`Work_Right_Mech_Share`,`Work_Right_Mech_Special`,`Work_Right_Mech_Org_Id`,`Created_Date`,`Rowversion`) values (1,2,'A1006',4,'50.00','DI',1,'10.00','IN',1,'2015-05-21 13:42:23','0000-00-00 00:00:00');
...
insert  into `wipo_work_subtitle`(`Work_Subtitle_Id`,`Work_Id`,`Work_Subtitle_Name`,`Work_Subtitle_Type_Id`,`Work_Subtitle_Language_Id`,`Created_Date`,`Rowversion`) values (1,2,'Sub title One',1,1,'2015-05-14 13:12:47','0000-00-00 00:00:00'),(2,2,'Sub title Two 2',1,1,'2015-05-14 13:14:12','0000-00-00 00:00:00');
