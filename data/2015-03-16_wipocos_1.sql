...
CREATE TABLE `wipo_author_account` (
  ...
  `Auth_Pseudo_Surname` varchar(50) NOT NULL,
  `Active` enum('0','1') NOT NULL DEFAULT '1',
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Auth_Acc_Id`),
  KEY `Auth_Account_index` (`Auth_Place_Of_Birth_Id`,`Auth_Birth_Country_Id`,`Auth_Nationality_Id`,`Auth_Language_Id`,`Auth_Marital_Status_Id`,`Auth_Pseudo_Type_Id`),
...
CREATE TABLE `wipo_author_account_address` (
  ...
  `Auth_Home_Address` text NOT NULL,
  `Auth_Mailing_Address` text NOT NULL,
  `Auth_Telephone` varchar(25) NOT NULL,
  `Auth_Fax` varchar(25) DEFAULT NULL,
  `Auth_Email` varchar(50) NOT NULL,
  `Auth_Website` varchar(100) DEFAULT NULL,
...
CREATE TABLE `wipo_author_biography` (
  ...
  `Auth_Acc_Id` int(11) NOT NULL,
  `Auth_Biogrph_Affli_Groups_Id` int(11) NOT NULL,
  `Auth_Biogrph_Annotation` varchar(500) DEFAULT NULL,
  `Active` enum('0','1') NOT NULL DEFAULT '1',
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `wipo_author_death_inheritance` (
  ...
  `Auth_Death_Inhrt_Addtion_Annotation` varchar(500) DEFAULT NULL,
...
CREATE TABLE `wipo_author_payment_method` (
  ...
  `Auth_Bank_Account` varchar(255) DEFAULT NULL,
  `Active` enum('0','1') NOT NULL DEFAULT '1',
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Auth_Pay_Id`),
  KEY `FK_wipo_author_payment_method_account_id` (`Auth_Acc_Id`),
  KEY `FK_wipo_author_payment_method_payment_method` (`Auth_Pay_Method_id`),
  CONSTRAINT `FK_wipo_author_payment_method_payment_method` FOREIGN KEY (`Auth_Pay_Method_id`) REFERENCES `wipo_master_payment_method` (`Master_Paymode_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
