...
CREATE TABLE `wipo_customer_user` (
  ...
  `User_Cust_Code` varchar(25) NOT NULL,
...
insert  into `wipo_email_template`(`Email_Temp_Id`,`Email_Temp_Name`,`Email_Temp_From`,`Email_Temp_ReplyTo`,`Email_Temp_Subject`,`Email_Temp_Content`,`Email_Temp_Params`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (1,'Contract Template','softwaretesterid@gmail.com','softwaretesterid@gmail.com','{{CURRENT_MONTH}} Invoice {{INVOICE_NO}} From {{SOCIRTY_NAME}}','Hi {{CUSTOMER_NAME}} ,\r\nHere is your {{CURRENT_MONTH}} invoice {{INVOICE_NO}}  for {{INVOICE_AMOUNT}} \r\nIf you have any question please let us know.','CURRENT_MONTH,INVOICE_NO,SOCIETY_NAME,INVOICE_AMOUNT','2015-08-08 18:59:11','0000-00-00 00:00:00',NULL,NULL);
...
insert  into `wipo_recording_session_documentation`(`Rcd_Ses_Doc_Id`,`Rcd_Ses_Id`,`Rcd_Ses_Doc_Status_Id`,`Rcd_Ses_Doc_Type_Id`,`Rcd_Ses_Doc_Sign_Date`,`Rcd_Ses_Doc_File`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (7,3,1,1,'2015-07-07','','2015-07-15 18:42:16','0000-00-00 00:00:00',1,NULL),(8,2,1,1,'2015-07-01','','2015-07-15 19:26:38','0000-00-00 00:00:00',1,NULL),(10,5,1,1,'2015-07-07','','2015-07-21 18:38:01','0000-00-00 00:00:00',1,NULL),(11,6,1,1,'2015-07-29','','2015-08-03 11:15:33','0000-00-00 00:00:00',1,NULL),(12,7,1,1,'2015-08-19','','2015-08-05 18:11:17','0000-00-00 00:00:00',1,NULL);
