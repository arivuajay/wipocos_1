...
CREATE TABLE `wipo_work_rightholder` (
  ...
  `Work_Id` int(11) NOT NULL,
  `Work_Right_Surname` varchar(100) NOT NULL,
  `Work_Right_Firstname` varchar(255) NOT NULL,
  `Work_Right_Internal_Code` varchar(100) NOT NULL,
  `Work_Right_User_Type` varchar(10) NOT NULL COMMENT 'AU => Author, PU => Publisher',
  `Work_Right_Role_Id` int(11) NOT NULL,
