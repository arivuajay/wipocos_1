...
CREATE TABLE `wipo_sound_carrier` (
  ...
  `Sound_Car_Medium` varchar(100) NOT NULL,
  `Sound_Car_Type_Id` int(11) DEFAULT NULL,
  `Sound_Car_Main_Artist` varchar(100) NOT NULL,
  `Sound_Car_Producer` varchar(100) NOT NULL,
...
insert  into `wipo_sound_carrier`(`Sound_Car_Id`,`Sound_Car_GUID`,`Sound_Car_Title`,`Sound_Car_Language_Id`,`Sound_Car_Internal_Code`,`Sound_Car_Standardized_Code`,`Sound_Car_Catelog`,`Sound_Car_Barcode`,`Sound_Car_Label_Id`,`Sound_Car_Distributor`,`Sound_Car_Medium`,`Sound_Car_Type_Id`,`Sound_Car_Main_Artist`,`Sound_Car_Producer`,`Sound_Car_Product_Country_Id`,`Sound_Car_Year`,`Sound_Car_Release_Year`,`Sound_Car_Manf_Id`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (8,'9FACA458-F484-C45B-88CF-E7FA7F79F976','Sound carrier 1',5,'SOC-SC-0000007','Test','catelog','barcode',1,'distributer','1',4,'Test','test',2,2015,2015,1,'2015-07-07 17:55:01','2015-07-07 14:26:32',1,1);
...
CREATE TABLE `wipo_sound_carrier_fixations` (
  ...
  `Sound_Car_Fix_GUID` varchar(50) NOT NULL,
...
insert  into `wipo_sound_carrier_publication`(`Sound_Car_Publ_Id`,`Sound_Car_Id`,`Sound_Car_Publ_Internal_Code`,`Sound_Car_Publ_Year`,`Sound_Car_Publ_Country_Id`,`Sound_Car_Publ_Prod_Nation_Id`,`Sound_Car_Publ_Studio`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (4,8,'SOC-SP-0000003',2000,2,2,2,'2015-07-07 17:55:19','0000-00-00 00:00:00',1,NULL);
