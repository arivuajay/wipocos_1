...
insert  into `wipo_group_members`(`Group_Member_Id`,`Group_Id`,`Group_Member_GUID`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (5,1,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:02:45','0000-00-00 00:00:00',1,NULL),(7,5,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:02:45','0000-00-00 00:00:00',1,NULL),(9,4,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:16:34','0000-00-00 00:00:00',1,NULL),(10,5,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:16:34','0000-00-00 00:00:00',1,NULL),(12,3,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:42:07','0000-00-00 00:00:00',1,NULL),(13,3,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:42:07','0000-00-00 00:00:00',1,NULL),(14,3,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:42:07','0000-00-00 00:00:00',1,NULL),(15,9,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-04-11 10:47:09','0000-00-00 00:00:00',1,NULL),(16,17,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-05-13 15:37:48','0000-00-00 00:00:00',1,NULL),(17,17,'c08b8b32-14e4-11e5-b10a-74d435d335fe','2015-05-13 15:37:48','0000-00-00 00:00:00',1,NULL),(20,2,'c08b90a4-14e4-11e5-b10a-74d435d335fe','2015-06-24 10:50:38','0000-00-00 00:00:00',1,NULL),(21,4,'c08b90a4-14e4-11e5-b10a-74d435d335fe','2015-06-24 10:50:38','0000-00-00 00:00:00',1,NULL),(27,3,'c08b4443-14e4-11e5-b10a-74d435d335fe','2015-07-03 11:45:36','0000-00-00 00:00:00',1,NULL),(28,5,'c08b4443-14e4-11e5-b10a-74d435d335fe','2015-07-03 11:45:36','0000-00-00 00:00:00',1,NULL),(29,14,'c08b4443-14e4-11e5-b10a-74d435d335fe','2015-07-03 11:45:36','0000-00-00 00:00:00',1,NULL),(31,2,'6170D906-040B-5C94-66C6-6BCC32E0CD1A','2015-07-03 12:06:40','0000-00-00 00:00:00',1,NULL);
...
insert  into `wipo_internalcode_generate`(`Gen_Inter_Code_Id`,`Gen_User_Type`,`Gen_Prefix`,`Gen_Inter_Code`,`Gen_Suffix`,`Gen_Code_Pad`) values (1,'A','A','1039',NULL,7),(2,'P','P','1019',NULL,7),(3,'G','G','1014',NULL,7),(4,'O','SOC','003',NULL,3),(5,'PU','E','114',NULL,7),(6,'PG','EG','109',NULL,7),(7,'PR','PR','111',NULL,7),(8,'W','W','22',NULL,7),(9,'R','R','112',NULL,7),(10,'GA','GA','2',NULL,7),(11,'GP','GP','2',NULL,7),(12,'GE','GE','2',NULL,7),(13,'GR','GPR','3',NULL,7),(14,'AP','AP','43',NULL,7),(15,'EP','EPR','9',NULL,7),(16,'RP','S','2',NULL,7);
...
/*Table structure for table `wipo_sound_recording` */

DROP TABLE IF EXISTS `wipo_sound_recording`;

CREATE TABLE `wipo_sound_recording` (
  `Sound_Rcd_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_GUID` varchar(50) NOT NULL,
  `Sound_Rcd_Title` varchar(255) NOT NULL,
  `Sound_Rcd_Language_Id` int(11) DEFAULT NULL,
  `Sound_Rcd_Internal_Code` varchar(100) NOT NULL,
  `Sound_Rcd_Standardized_Code` varchar(100) NOT NULL,
  `Sound_Rcd_Catelog` varchar(100) DEFAULT NULL,
  `Sound_Rcd_Barcode` varchar(255) DEFAULT NULL,
  `Sound_Rcd_Distributor` varchar(100) DEFAULT NULL,
  `Sound_Rcd_Label_Id` varchar(20) DEFAULT NULL,
  `Sound_Rcd_Medium` varchar(100) NOT NULL,
  `Sound_Rcd_Type_Id` int(11) NOT NULL,
  `Sound_Rcd_Main_Artist` varchar(100) NOT NULL,
  `Sound_Rcd_Producer` varchar(100) NOT NULL,
  `Sound_Rcd_Product_Country_Id` int(11) NOT NULL,
  `Sound_Rcd_Year` year(4) NOT NULL,
  `Sound_Rcd_Release_Year` year(4) NOT NULL,
  `Sound_Rcd_Manf_Id` int(11) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Id`),
  UNIQUE KEY `NewIndex1` (`Sound_Rcd_Internal_Code`),
  KEY `FK_wipo_sound_recording_language` (`Sound_Rcd_Language_Id`),
  KEY `FK_wipo_sound_recording_type` (`Sound_Rcd_Type_Id`),
  KEY `FK_wipo_sound_recording_production_country` (`Sound_Rcd_Product_Country_Id`),
  KEY `FK_wipo_sound_recording` (`Sound_Rcd_Manf_Id`),
  CONSTRAINT `FK_wipo_sound_recording` FOREIGN KEY (`Sound_Rcd_Manf_Id`) REFERENCES `wipo_master_manufacturer` (`Master_Manf_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_language` FOREIGN KEY (`Sound_Rcd_Language_Id`) REFERENCES `wipo_master_language` (`Master_Lang_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_production_country` FOREIGN KEY (`Sound_Rcd_Product_Country_Id`) REFERENCES `wipo_master_country` (`Master_Country_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_type` FOREIGN KEY (`Sound_Rcd_Type_Id`) REFERENCES `wipo_master_type` (`Master_Type_Id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording` */

/*Table structure for table `wipo_sound_recording_biograph_uploads` */

DROP TABLE IF EXISTS `wipo_sound_recording_biograph_uploads`;

CREATE TABLE `wipo_sound_recording_biograph_uploads` (
  `Sound_Rcd_Biogrph_Upl_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Biogrph_Id` int(11) NOT NULL,
  `Sound_Rcd_Biogrph_Upl_File` varchar(500) NOT NULL,
  `Sound_Rcd_Biogrph_Upl_Description` text,
  `Created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Biogrph_Upl_Id`),
  KEY `FK_wipo_sound_recording_biograph_uploads_biography` (`Sound_Rcd_Biogrph_Id`),
  CONSTRAINT `FK_wipo_sound_recording_biograph_uploads_biography` FOREIGN KEY (`Sound_Rcd_Biogrph_Id`) REFERENCES `wipo_sound_recording_biography` (`Sound_Rcd_Biogrph_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_biograph_uploads` */

/*Table structure for table `wipo_sound_recording_biography` */

DROP TABLE IF EXISTS `wipo_sound_recording_biography`;

CREATE TABLE `wipo_sound_recording_biography` (
  `Sound_Rcd_Biogrph_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Id` int(11) NOT NULL,
  `Sound_Rcd_Biogrph_Annotation` text NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Biogrph_Id`),
  KEY `FK_wipo_sound_recording_biography_rcd` (`Sound_Rcd_Id`),
  CONSTRAINT `FK_wipo_sound_recording_biography_rcd` FOREIGN KEY (`Sound_Rcd_Id`) REFERENCES `wipo_sound_recording` (`Sound_Rcd_Id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_biography` */

/*Table structure for table `wipo_sound_recording_documentation` */

DROP TABLE IF EXISTS `wipo_sound_recording_documentation`;

CREATE TABLE `wipo_sound_recording_documentation` (
  `Sound_Rcd_Doc_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Id` int(11) NOT NULL,
  `Sound_Rcd_Doc_Status_Id` int(11) NOT NULL,
  `Sound_Rcd_Doc_Type_Id` int(11) NOT NULL,
  `Sound_Rcd_Doc_Sign_Date` date NOT NULL,
  `Sound_Rcd_Doc_File` varchar(255) DEFAULT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Doc_Id`),
  KEY `FK_wipo_sound_recording_documentation_work` (`Sound_Rcd_Id`),
  KEY `FK_wipo_sound_recording_documentation_document_status` (`Sound_Rcd_Doc_Status_Id`),
  KEY `FK_wipo_sound_recording_documentation_document_type` (`Sound_Rcd_Doc_Type_Id`),
  CONSTRAINT `FK_wipo_sound_recording_documentation_document_status` FOREIGN KEY (`Sound_Rcd_Doc_Status_Id`) REFERENCES `wipo_master_document_status` (`Master_Document_Sts_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_documentation_document_type` FOREIGN KEY (`Sound_Rcd_Doc_Type_Id`) REFERENCES `wipo_master_document` (`Master_Doc_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_documentation_work` FOREIGN KEY (`Sound_Rcd_Id`) REFERENCES `wipo_sound_recording` (`Sound_Rcd_Id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_documentation` */

/*Table structure for table `wipo_sound_recording_fixations` */

DROP TABLE IF EXISTS `wipo_sound_recording_fixations`;

CREATE TABLE `wipo_sound_recording_fixations` (
  `Sound_Rcd_Fix_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Fix_GUID` varchar(50) NOT NULL,
  `Sound_Rcd_Fix_Duration` time NOT NULL,
  `Sound_Rcd_Fix_Date` date NOT NULL,
  `Sound_Rcd_Fix_Studio` int(11) NOT NULL,
  `Sound_Rcd_Fix_Country_Id` int(11) NOT NULL,
  PRIMARY KEY (`Sound_Rcd_Fix_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_fixations` */

/*Table structure for table `wipo_sound_recording_publication` */

DROP TABLE IF EXISTS `wipo_sound_recording_publication`;

CREATE TABLE `wipo_sound_recording_publication` (
  `Sound_Rcd_Publ_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Id` int(11) NOT NULL,
  `Sound_Rcd_Publ_Internal_Code` varchar(100) NOT NULL,
  `Sound_Rcd_Publ_Year` year(4) NOT NULL,
  `Sound_Rcd_Publ_Country_Id` int(11) NOT NULL,
  `Sound_Rcd_Publ_Prod_Nation_Id` int(11) NOT NULL,
  `Sound_Rcd_Publ_Studio` int(11) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Publ_Id`),
  UNIQUE KEY `NewIndex1` (`Sound_Rcd_Publ_Internal_Code`),
  KEY `FK_wipo_sound_recording_publication_recording` (`Sound_Rcd_Id`),
  KEY `FK_wipo_sound_recording_publication_country` (`Sound_Rcd_Publ_Country_Id`),
  KEY `FK_wipo_sound_recording_publication_nationality` (`Sound_Rcd_Publ_Prod_Nation_Id`),
  CONSTRAINT `FK_wipo_sound_recording_publication_country` FOREIGN KEY (`Sound_Rcd_Publ_Country_Id`) REFERENCES `wipo_master_country` (`Master_Country_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_publication_nationality` FOREIGN KEY (`Sound_Rcd_Publ_Prod_Nation_Id`) REFERENCES `wipo_master_nationality` (`Master_Nation_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_publication_recording` FOREIGN KEY (`Sound_Rcd_Id`) REFERENCES `wipo_sound_recording` (`Sound_Rcd_Id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_publication` */

/*Table structure for table `wipo_sound_recording_subtitle` */

DROP TABLE IF EXISTS `wipo_sound_recording_subtitle`;

CREATE TABLE `wipo_sound_recording_subtitle` (
  `Sound_Rcd_Subtitle_Id` int(11) NOT NULL AUTO_INCREMENT,
  `Sound_Rcd_Id` int(11) NOT NULL,
  `Sound_Rcd_Subtitle_Name` varchar(255) NOT NULL,
  `Sound_Rcd_Subtitle_Type_Id` int(11) NOT NULL,
  `Sound_Rcd_Subtitle_Language_Id` int(11) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `Created_By` int(11) DEFAULT NULL,
  `Updated_By` int(11) DEFAULT NULL,
  PRIMARY KEY (`Sound_Rcd_Subtitle_Id`),
  KEY `FK_wipo_sound_recording_subtitle_recording` (`Sound_Rcd_Id`),
  KEY `FK_wipo_sound_recording_subtitle_type` (`Sound_Rcd_Subtitle_Type_Id`),
  KEY `FK_wipo_sound_recording_subtitle_language` (`Sound_Rcd_Subtitle_Language_Id`),
  CONSTRAINT `FK_wipo_sound_recording_subtitle_language` FOREIGN KEY (`Sound_Rcd_Subtitle_Language_Id`) REFERENCES `wipo_master_language` (`Master_Lang_Id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_wipo_sound_recording_subtitle_recording` FOREIGN KEY (`Sound_Rcd_Id`) REFERENCES `wipo_sound_recording` (`Sound_Rcd_Id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_wipo_sound_recording_subtitle_type` FOREIGN KEY (`Sound_Rcd_Subtitle_Type_Id`) REFERENCES `wipo_master_type` (`Master_Type_Id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `wipo_sound_recording_subtitle` */
