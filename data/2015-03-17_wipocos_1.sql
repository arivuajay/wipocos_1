...
CREATE TABLE `wipo_number_assignment` (
  ...
  `Num_Assgn_System_Id` int(11) NOT NULL,
...
CREATE TABLE `wipo_organization` (
  ...
  `Org_Hirearchy_Id` int(11) DEFAULT NULL,
  `Org_Payment_Id` int(11) DEFAULT NULL,
  `Org_Type_Id` int(11) DEFAULT NULL,
  `Org_Factor_Id` int(11) DEFAULT NULL,
  ...
  `Org_Main_Performer_Id` int(11) DEFAULT NULL,
  `Org_Producer_Id` int(11) DEFAULT NULL,
  `Active` enum('0','1') NOT NULL DEFAULT '1',
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Org_Id`),
  ...
  KEY `FK_wipo_organization_document_type` (`Org_Doc_Type_Id`),
  CONSTRAINT `FK_wipo_organization_document_type` FOREIGN KEY (`Org_Doc_Type_Id`) REFERENCES `wipo_master_document_status` (`Master_Document_Sts_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
