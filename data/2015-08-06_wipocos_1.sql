...
insert  into `wipo_contract_invoice`(`Inv_Id`,`Inv_Date`,`Tarf_Cont_Id`,`Inv_Repeat_Id`,`Inv_Repeat_Count`,`Inv_Next_Date`,`Created_Date`,`Rowversion`,`Created_By`,`Updated_By`) values (1,'2015-08-06',2,1,7,'2015-08-12','2015-08-06 15:26:29','2015-08-06 16:01:47',1,1);
...
CREATE TABLE `wipo_tariff_contracts` (
  ...
  `Tarf_Invoice` varchar(50) NOT NULL,
  ...
  UNIQUE KEY `NewIndex1` (`Tarf_Invoice`),
