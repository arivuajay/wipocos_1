...
insert  into `wipo_internalcode_generate`(`Gen_Inter_Code_Id`,`Gen_User_Type`,`Gen_Prefix`,`Gen_Inter_Code`,`Gen_Suffix`) values (1,'A','A','1019',NULL),(2,'P','P','1005',NULL),(3,'G','G','1014',NULL),(4,'O','SOC','003',NULL),(5,'PU','E','109',NULL),(6,'PG','EG','108',NULL),(7,'PR','R','106',NULL),(8,'W','A','0000009',NULL);
...
CREATE TABLE `wipo_work` (
  ...
  `Work_Unknown` enum('Y','N') NOT NULL DEFAULT 'N',
  `Active` enum('0','1') NOT NULL DEFAULT '1',
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Work_Id`),
