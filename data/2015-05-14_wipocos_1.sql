...
insert  into `wipo_internalcode_generate`(`Gen_Inter_Code_Id`,`Gen_User_Type`,`Gen_Prefix`,`Gen_Inter_Code`,`Gen_Suffix`) values (1,'A','A','1018',NULL),(2,'P','P','1005',NULL),(3,'G','G','1014',NULL),(4,'O','SOC','003',NULL),(5,'PU','E','109',NULL),(6,'PG','EG','108',NULL),(7,'PR','R','106',NULL),(8,'W','A','0000004',NULL);
...
insert  into `wipo_master_instrument`(`Master_Inst_Id`,`Instrument_Name`,`Active`,`Created_Date`,`Rowversion`) values (1,'Guitar','1','2015-05-14 18:11:48','0000-00-00 00:00:00'),(2,'Violin','1','2015-05-14 18:11:51','0000-00-00 00:00:00'),(3,'Tabla','1','2015-05-14 18:12:46','0000-00-00 00:00:00');
...
insert  into `wipo_master_type_rights`(`Master_Type_Rights_Id`,`Type_Rights_Name`,`Active`,`Created_Date`,`Rowversion`) values (1,'MC- Music composer','1','2015-03-13 18:48:28','0000-00-00 00:00:00'),(2,'Music Publisher','1','2015-05-07 13:20:09','0000-00-00 00:00:00'),(3,'Producer','1','2015-05-07 13:20:16','0000-00-00 00:00:00');
...
CREATE TABLE `wipo_work` (
  ...
  `Work_Instrumentation` varchar(10) DEFAULT NULL,
...
insert  into `wipo_work`(`Work_Id`,`Work_Org_Title`,`Work_Language_Id`,`Work_Internal_Code`,`Work_Iswc`,`Work_Wic_Code`,`Work_Type_Id`,`Work_Factor_Id`,`Work_Instrumentation`,`Work_Duration`,`Work_Creation`,`Work_Opus_Number`,`Active`,`Created_Date`,`Rowversion`) values (2,'Music 1',1,'A0000001','89841515','895515415',1,1,'1,2,3','120:50:50',2015,NULL,'1','2015-05-13 19:05:04','0000-00-00 00:00:00'),(3,'Music 2',1,'A0000002','89841515','895515415',1,1,'','02:06:00',2015,NULL,'1','2015-05-13 19:09:28','0000-00-00 00:00:00'),(4,'Music 3',1,'A0000003','89841515','895515415',1,1,'','00:00:00',2015,NULL,'1','2015-05-14 18:00:19','0000-00-00 00:00:00');
...
insert  into `wipo_work_documentation`(`Work_Doc_Id`,`Work_Id`,`Work_Doc_Status_Id`,`Work_Doc_Inclusion`,`Work_Doc_Dispute`,`Work_Doc_Type_Id`,`Work_Doc_Sign_Date`,`Work_Doc_File`,`Created_Date`,`Rowversion`) values (1,2,1,'Y','Y',1,'2015-05-14','files','2015-05-14 19:33:18','0000-00-00 00:00:00');
...
CREATE TABLE `wipo_work_publishing` (
  ...
  `Work_Pub_Territory_Id` int(11) NOT NULL,
  `Work_Pub_Sign_Date` date NOT NULL,
  `Work_Pub_File` varchar(255) NOT NULL,
  `Work_Pub_References` smallint(6) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Work_Pub_Id`),
  KEY `FK_wipo_work_publishing_territory` (`Work_Pub_Territory_Id`),
  KEY `FK_wipo_work_publishing_work` (`Work_Id`),
  CONSTRAINT `FK_wipo_work_publishing_territory` FOREIGN KEY (`Work_Pub_Territory_Id`) REFERENCES `wipo_master_territories` (`Master_Territory_Id`) ON UPDATE CASCADE,
...
CREATE TABLE `wipo_work_rightholder` (
  ...
  `Work_Right_Type` varchar(2) NOT NULL COMMENT 'AU => Author, PU => Publisher',
  `Work_Right_Role_Id` int(11) NOT NULL,
  `Work_Right_Broad_Share` decimal(10,2) NOT NULL,
  `Work_Right_Broad_Special` varchar(50) DEFAULT NULL,
  `Work_Right_Broad_Org_id` int(11) NOT NULL,
  `Work_Right_Mech_Share` decimal(10,2) NOT NULL,
  `Work_Right_Mech_Special` varchar(50) DEFAULT NULL,
...
CREATE TABLE `wipo_work_sub_publishing` (
  ...
  `Work_Sub_Territory_Id` int(11) NOT NULL,
  `Work_Sub_Clause` enum('Made','Sale') NOT NULL DEFAULT 'Made',
  `Work_Sub_Sign_Date` date NOT NULL,
  `Work_Sub_File` varchar(255) NOT NULL,
  `Work_Sub_References` smallint(6) NOT NULL,
  `Created_Date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `Rowversion` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`Work_Sub_Id`),
  KEY `FK_wipo_work_sub_publishing_territory` (`Work_Sub_Territory_Id`),
  KEY `FK_wipo_work_sub_publishing_work` (`Work_Id`),
  CONSTRAINT `FK_wipo_work_sub_publishing_territory` FOREIGN KEY (`Work_Sub_Territory_Id`) REFERENCES `wipo_master_territories` (`Master_Territory_Id`) ON UPDATE CASCADE,
