...
//    const FILE_SIZE = 10;
    ...
    public function init() {
        ...
        if($this->isNewRecord){
            ...
            $this->Perf_Rel_Region_Id = DEFAULT_REGION_ID;
            $this->Perf_Rel_Avl_Work_Cat_Id = DEFAULT_WORK_CATEGORY_ID;
            $this->Perf_Rel_Internal_Position_Id = DEFAULT_INTERNAL_POSITION_ID;
