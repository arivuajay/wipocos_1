...
class AuthorAccountAddress extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'Auth_Home_Address_3' => 'Home Address 3',
			'Auth_Home_Fax' => 'Home Fax',
			'Auth_Home_Telephone' => 'Home Telephone',
			'Auth_Home_Email' => 'Home Email',
			'Auth_Home_Website' => 'Home Website',
			'Auth_Mailing_Address_1' => 'Mailing Address 1',
			'Auth_Mailing_Address_2' => 'Mailing Address 2',
			'Auth_Mailing_Address_3' => 'Mailing Address 3',
			'Auth_Mailing_Telephone' => 'Mailing Telephone',
			'Auth_Mailing_Fax' => 'Mailing Fax',
			'Auth_Mailing_Email' => 'Mailing Email',
			'Auth_Mailing_Website' => 'Mailing Website',
