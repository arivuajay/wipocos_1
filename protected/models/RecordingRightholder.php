...
class RecordingRightholder extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'recordingAuthor' => array(self::BELONGS_TO, 'AuthorAccount', 'Rcd_Member_GUID', 'foreignKey' => array('Rcd_Member_GUID' => 'Auth_GUID'), 'order'=>'recordingAuthor.Auth_First_Name ASC'),
