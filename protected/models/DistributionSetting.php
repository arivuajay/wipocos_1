 ...
 */
class DistributionSetting extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Setting_Date', 'required'),
			array('Closing_Distribute, Created_By, Updated_By', 'numerical', 'integerOnly'=>true),
			array('Total_Distribute', 'length', 'max'=>10),
			array('Created_Date, Rowversion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Setting_Id, Setting_Date, Total_Distribute, Closing_Distribute, Created_Date, Rowversion, Created_By, Updated_By', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'Total_Distribute' => 'Total Distribute',
