...
class PerformerAccountAddress extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Perf_Home_Address_1, Perf_Home_Address_2, Perf_Home_Address_3, Perf_Mailing_Address_1, Perf_Mailing_Address_2, Perf_Mailing_Address_3, Perf_Performer_Account_1, Perf_Performer_Account_2, Perf_Performer_Account_3, Perf_Performer_Account_1, Perf_Performer_Account_2, Perf_Performer_Account_3', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
			...
			'Perf_Home_Address_1' => 'Home Address 1',
			'Perf_Home_Address_2' => 'Home Address 2',
			'Perf_Home_Address_3' => 'Home Address 3',
			'Perf_Home_Fax' => 'Home Fax',
			'Perf_Home_Telephone' => 'Home Telephone',
			'Perf_Home_Email' => 'Home Email',
			'Perf_Home_Website' => 'Home Website',
			'Perf_Mailing_Address_1' => 'Mailing Address 1',
			'Perf_Mailing_Address_2' => 'Mailing Address 2',
			'Perf_Mailing_Address_3' => 'Mailing Address 3',
			'Perf_Mailing_Telephone' => 'Mailing Telephone',
			'Perf_Mailing_Fax' => 'Mailing Fax',
			'Perf_Mailing_Email' => 'Mailing Email',
			'Perf_Mailing_Website' => 'Mailing Website',
