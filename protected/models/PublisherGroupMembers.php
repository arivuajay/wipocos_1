 ...
 * @property string $Pub_Group_Member_GUID
...
class PublisherGroupMembers extends RActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'Pub_Group_Member_GUID' => 'Pub Group Member Internal Code',
    ...
    public function search() {
        ...
        $criteria->compare('Pub_Group_Member_GUID', $this->Pub_Group_Member_GUID, true);
