...
//				$this->redirect(array('view','id'=>$model->Master_Marital_State_Id));
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterMaritalStatus Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterMaritalStatus();
        $searchModel = new MasterMaritalStatus('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterMaritalStatus'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterMaritalStatus'];
            $searchModel->search();
        }
