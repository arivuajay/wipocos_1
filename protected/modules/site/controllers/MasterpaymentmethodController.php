...
//				$this->redirect(array('view','id'=>$model->Master_Paymode_Id));
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterPaymentMethod Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterPaymentMethod();
        $searchModel = new MasterPaymentMethod('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterPaymentMethod'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterPaymentMethod'];
            $searchModel->search();
        }
    ...
    public function actionAdmin() {
        $model = new MasterPaymentMethod('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterPaymentMethod']))
            $model->attributes = $_GET['MasterPaymentMethod'];
     ...
     * @return MasterPaymentMethod the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = MasterPaymentMethod::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MasterPaymentMethod $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-payment-method-form') {
