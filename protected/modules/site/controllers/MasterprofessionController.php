...
class MasterprofessionController extends Controller {
    /**
...
//				$this->redirect(array('view','id'=>$model->Master_Profession_Id));
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterProfession Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterProfession();
        $searchModel = new MasterProfession('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterProfession'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterProfession'];
            $searchModel->search();
        }
    ...
    public function actionAdmin() {
        $model = new MasterProfession('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterProfession']))
            $model->attributes = $_GET['MasterProfession'];
     ...
     * @return MasterProfession the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = MasterProfession::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MasterProfession $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-profession-form') {
