...
class MastertyperightsController extends Controller {
    /**
...
//				$this->redirect(array('view','id'=>$model->Master_Type_Rights_Id));
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterTypeRights Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterTypeRights();
        $searchModel = new MasterTypeRights('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterTypeRights'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterTypeRights'];
            $searchModel->search();
        }
    ...
    public function actionAdmin() {
        $model = new MasterTypeRights('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterTypeRights']))
            $model->attributes = $_GET['MasterTypeRights'];
     ...
     * @return MasterTypeRights the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = MasterTypeRights::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MasterTypeRights $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-type-rights-form') {
