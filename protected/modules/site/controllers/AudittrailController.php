...
class AudittrailController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['AuditTrail'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'AuditTrail Created Successfully!!!');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['AuditTrail'])) {
            $model->attributes = $_POST['AuditTrail'];
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'AuditTrail Updated Successfully!!!');
                $this->redirect(array('index'));
            }
        }
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'AuditTrail Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new AuditTrail();
        $searchModel = new AuditTrail('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['AuditTrail'])) {
            $search = true;
            $searchModel->attributes = $_GET['AuditTrail'];
            $searchModel->search();
        }
