...
//				$this->redirect(array('view','id'=>$model->Master_Region_Id));
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterRegion Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterRegion();
        $searchModel = new MasterRegion('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterRegion'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterRegion'];
            $searchModel->search();
        }
    ...
    public function actionAdmin() {
        $model = new MasterRegion('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterRegion']))
            $model->attributes = $_GET['MasterRegion'];
    ...
    public function loadModel($id) {
        $model = MasterRegion::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MasterRegion $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-region-form') {
