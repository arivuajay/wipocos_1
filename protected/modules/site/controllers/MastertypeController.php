...
class MastertypeController extends Controller {
    ...
    public function actionDelete($id) {
        ...
        if (!isset($_GET['ajax'])) {
            Yii::app()->user->setFlash('success', 'MasterType Deleted Successfully!!!');
    ...
    public function actionIndex() {
        ...
        $model = new MasterType();
        $searchModel = new MasterType('search');
        $searchModel->unsetAttributes();  // clear any default values
        if (isset($_GET['MasterType'])) {
            $search = true;
            $searchModel->attributes = $_GET['MasterType'];
            $searchModel->search();
        }
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'master-type-form') {
