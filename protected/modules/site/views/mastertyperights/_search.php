...
<div class="wide form">
    ...
    <div class="row">
        <?php echo $form->label($model, 'Master_Type_Rights_Id'); ?>
        <?php echo $form->textField($model, 'Master_Type_Rights_Id', array('class' => 'form-control')); ?>
    </div>

    <div class="row">
        <?php echo $form->label($model, 'Type_Rights_Name'); ?>
