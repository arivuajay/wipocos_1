...
$this->title='Master Coefficients';
...
<div class="col-lg-12 col-md-12" id="advance-search-block">
	...
	'id'=>'search-form',
	'method'=>'get',
        'action' => array('/site/mastercoefficient/index'),
        'htmlOptions' => array('role' => 'form')
)); ?>

                                         <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel,'Coefficient',  array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel,'Coefficient',array('class'=>'form-control','size'=>10,'maxlength'=>10)); ?>
                        </div>
                    </div>
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel,'Coeff_Name',  array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel,'Coeff_Name',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
                        </div>
                    </div>
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
...
<div class="col-lg-12 col-md-12">
    <div class="row">
        ...
        <?php        $this->widget(
            ...
            'label' => 'Create MasterCoefficient',
            'icon' => 'fa fa-plus',
            'url' => array('/site/mastercoefficient/create'),
            'buttonType' => 'link',
            'context' => 'success',
...
<?php
		...
		array(
            ...
            'responsiveTable' => true,
            'template' => '<div class="panel panel-primary"><div class="panel-heading"><div class="pull-right">{summary}</div><h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>  Master Coefficients</h3></div><div class="panel-body">{items}{pager}</div></div>',
            'columns' => $gridColumns
                )
        );
        ?>
