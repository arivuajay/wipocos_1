    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Country_Two_Code', array('class' => 'col-sm-2 control-label')); ?>
                    <div class="col-sm-5">
                        <?php echo $form->textField($model, 'Country_Two_Code', array('class' => 'form-control', 'size' => 2, 'maxlength' => 2)); ?>
                        <?php echo $form->error($model, 'Country_Two_Code'); ?>
                    </div>
                </div>

                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Country_Three_Code', array('class' => 'col-sm-2 control-label')); ?>
                    <div class="col-sm-5">
                        <?php echo $form->textField($model, 'Country_Three_Code', array('class' => 'form-control', 'size' => 3, 'maxlength' => 3)); ?>
                        <?php echo $form->error($model, 'Country_Three_Code'); ?>
                    </div>
                </div>
