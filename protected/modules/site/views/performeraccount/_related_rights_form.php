    ...
    <div class="col-lg-5 col-xs-5">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Perf_Rel_Society_Id', $societies, array('class' => 'form-control', 'prompt' => '')); ?>
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Perf_Rel_Internal_Position_Id', $internal_positions, array('class' => 'form-control', 'prompt' => '')); ?>
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Perf_Rel_Avl_Work_Cat_Id', $work_categories, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Perf_Rel_Avl_Work_Cat_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Perf_Rel_Type_Rght_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Perf_Rel_Type_Rght_Id', $right_types, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Perf_Rel_Type_Rght_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Perf_Rel_Managed_Rights_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Perf_Rel_Managed_Rights_Id', $managed_rights, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Perf_Rel_Managed_Rights_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Perf_Rel_Territories_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Perf_Rel_Territories_Id', $territories, array('class' => 'form-control', 'prompt' => '')); ?>
