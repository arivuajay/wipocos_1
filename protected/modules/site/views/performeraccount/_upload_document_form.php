...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <?php echo $form->textField($model, 'Perf_Upl_Doc_Name', array('class' => 'form-control', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Perf_Upl_Doc_Name'); ?>
            </div>
        </div>

        <div class="form-group">
            <?php echo $form->labelEx($model, 'Perf_Upl_File', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php echo $form->fileField($model, 'Perf_Upl_File', array()); ?>
                <?php echo $form->error($model, 'Perf_Upl_File'); ?>
            </div>
        </div>
...
<?php
$uploaded_files = PerformerUpload::model()->findAll('Perf_Acc_Id = :acc_id', array(':acc_id' => $performer_model->Perf_Acc_Id));
