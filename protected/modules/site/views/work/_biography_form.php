<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($biograph_upload_model, 'Work_Biogrph_Upl_File', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php
                $max_size = WorkBiographUploads::IMAGE_SIZE;
                $this->widget('CMultiFileUpload', array(
                    'model' => $biograph_upload_model,
                    'name' => 'Work_Biogrph_Upl_File',
                    'accept' => WorkBiographUploads::ACCESS_TYPES_WID,
                ...
                ?>
                <?php echo $form->error($biograph_upload_model, 'Work_Biogrph_Upl_File'); ?>
            </div>
        </div>

        <div class="form-group">
            <?php echo $form->labelEx($biograph_upload_model, 'Work_Biogrph_Upl_Description', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php echo $form->textArea($biograph_upload_model, 'Work_Biogrph_Upl_Description', array('class' => 'form-control', 'rows' => 6, 'cols' => 50)); ?>
                <?php echo $form->error($biograph_upload_model, 'Work_Biogrph_Upl_Description'); ?>
            </div>
        </div>
...
<?php
$uploaded_files = WorkBiographUploads::model()->findAll('Work_Biogrph_Id = :bio_id', array(':bio_id' => $model->Work_Biogrph_Id));
