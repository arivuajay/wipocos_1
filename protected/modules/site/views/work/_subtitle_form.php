    ...
    <div class="box-body">
        <?php if (!$model->isNewRecord) { ?>
            <div class="col-lg-12 col-md-12">
                <div class="row mb10">
                    <?php echo CHtml::link('<i class="fa fa-plus"></i>&nbsp;&nbsp;New Subtitle', array("/site/work/update", 'id' => $work_model->Work_Id, 'tab' => '2'), array('class' => 'btn btn-success pull-right')) ?>
                </div>
            </div>
        <?php } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <?php echo $form->dropDownList($model, 'Work_Subtitle_Language_Id', $languages, array('class' => 'form-control', 'prompt' => '')); ?>
                ...
                <tbody><tr>
                    ...
                    <?php foreach ($sub_titles as $key => $sub_title) { ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                echo MyHtml::link('<i class="fa fa-pencil"></i>', array('/site/work/update/id/' . $work_model->Work_Id . '/tab/2/edit/' . $sub_title->Work_Subtitle_Id), array('title' => 'Edit'));
                                echo "&nbsp;&nbsp;";
                                echo MyHtml::link('<i class="fa fa-trash"></i>', array('/site/work/subtitledelete/id/' . $sub_title->Work_Subtitle_Id), array('title' => 'Delete', 'onclick' => 'return confirm("Are you sure to delete ?")'));
                                ?>
                            </td>
                        </tr>
                    <?php } ?>
