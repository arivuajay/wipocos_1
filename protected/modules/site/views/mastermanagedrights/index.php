...
$this->title = 'Master Managed Rights';
$this->breadcrumbs = array(
    'Master Managed Rights',
);
?>
            ...
            <section class="content">
                <div class="row">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'id' => 'search-form',
                        'method' => 'get',
                        'action' => array('/site/mastermanagedrights/index'),
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel, 'Mgd_Rights_Name', array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel, 'Mgd_Rights_Name', array('class' => 'form-control', 'size' => 60, 'maxlength' => 90)); ?>
                            <?php echo $form->error($searchModel, 'Mgd_Rights_Name'); ?>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
...
<div class="col-lg-12 col-md-12">
    <div class="row mb10">
        ...
        $this->widget(
            ...
            'label' => 'Create Master ManagedRights',
            'icon' => 'fa fa-plus',
            'url' => array('/site/mastermanagedrights/create'),
            'buttonType' => 'link',
            'context' => 'success',
...
<div class="col-lg-12 col-md-12">
    <div class="row">
        ...
        $this->widget('booster.widgets.TbExtendedGridView', array(
            ...
            'responsiveTable' => true,
            'template' => '<div class="panel panel-primary"><div class="panel-heading"><div class="pull-right">{summary}</div><h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>  Master Managed Rights</h3></div><div class="panel-body">{items}{pager}</div></div>',
            'columns' => $gridColumns
                )
        );
        ?>
