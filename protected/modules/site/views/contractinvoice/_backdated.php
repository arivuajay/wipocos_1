...
//                    'action' => $this->createUrl('/site/tariffcontracts/update', array('id' => $work_model->Work_Id, 'tab' => '7')),
    ...
    echo $form->hiddenField($new_model, 'Inv_Next_Date', array('value' => '0000-00-00'));
    echo $form->hiddenField($new_model, 'Inv_Repeat_Count', array('value' => 0));
    echo $form->hiddenField($new_model, 'Inv_Created_Mode', array('value' => 'B'))
    ?>
                            ...
                            <div class="col-lg-12 col-md-12 row">
                                <table id="search_result" class="table table-bordered selectable table-datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="highlight" data-uid="<?php echo $contract->Tarf_Cont_GUID ?>" data-id="<?php echo $contract->Tarf_Cont_Id ?>" data-custcode = "<?php echo $contract->tarfContUser->User_Cust_Code; ?>" data-invoice = "<?php echo $contract->Tarf_Invoice; ?>" data-amount = "<?php echo $contract->Tarf_Cont_Amt_Pay; ?>" data-contract-end= "<?php echo $contract->Tarf_Cont_To; ?>" data-repeat= "<?php echo $contract->getPayment(); ?>">
            ...
            <div class="form-group foundation">
                <div class="box-body">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <?php echo $form->labelEx($new_model, 'Inv_Date', array('class' => '')); ?>
                            <?php echo $form->textField($new_model, 'Inv_Date', array('class' => 'form-control date')); ?>
                            <?php echo $form->error($new_model, 'Inv_Date'); ?>
                        </div>
        ...
        $(document).ready(function(){
            ...
            $('body').on('click','#search_result tbody tr', function(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#invoice_to').val(_this.data('custcode'));
