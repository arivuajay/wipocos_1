                ...
                <table id="search_result" class="table table-bordered selectable table-datatable">
                    ...
                    <tbody>
                        ...
                        foreach ($contracts as $key => $contract) {
                            ?>
                        <tr data-uid="<?php echo $contract->Tarf_Cont_GUID ?>" data-id="<?php echo $contract->Tarf_Cont_Id ?>" data-custname = "<?php echo $contract->tarfContUser->User_Cust_Name; ?>" data-invoice = "<?php echo $contract->Tarf_Invoice; ?>" data-amount = "<?php echo $contract->Tarf_Cont_Amt_Pay; ?>" data-contract-end= "<?php echo $contract->Tarf_Cont_To; ?>">
