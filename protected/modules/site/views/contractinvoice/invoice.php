...
//    'label' => 'Download',
//    'url' => array('invoice', 'id' => $model->Inv_Id, 'export' => 'PDF'),
//    'buttonType' => 'link',
//    'context' => 'warning',
//        )
//);
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2 class="page-header">
                ...
                <small class="pull-right" style="float: right">Date: <?php echo date('d-m-Y', strtotime($model->Inv_Date)); ?></small>
            </h2>
        </div><!-- /.col -->
    </div>
    <!-- info row -->
    <div class="row invoice-info" <?php echo $export ? 'style="margin: 0 -15px;"' : '' ?>>
