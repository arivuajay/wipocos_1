...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'Master_City_Id'); ?>
		<?php echo $form->textField($model,'Master_City_Id',array('class'=>'form-control')); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'City_Code'); ?>
		<?php echo $form->textField($model,'City_Code',array('class'=>'form-control','size'=>20,'maxlength'=>20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'City_Name'); ?>
		<?php echo $form->textField($model,'City_Name',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
	</div>
