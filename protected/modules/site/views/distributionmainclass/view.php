...
$this->title='View DistributionMainClass:'.$model->Main_Class_Id;
$this->breadcrumbs=array(
	'Distribution Main Classes'=>array('index'),
	'View '.'DistributionMainClass',
);
?>
<div class="user-view">
    <?php    if ($export == false) {
    ...
    <p>
        <?php        $this->widget(
                'application.components.MyTbButton', array(
                    'label' => 'Update',
                    'url' => array('update', 'id' =>  $model->Main_Class_Id ),
                    'buttonType' => 'link',
                    'context' => 'primary',
                )
        );
        ...
        $this->widget(
                'application.components.MyTbButton', array(
                    'label' => 'Delete',
                    'url' => array('delete', 'id' =>  $model->Main_Class_Id ),
                    'buttonType' => 'link',
                    'context' => 'danger',
        ...
        $this->widget(
                'application.components.MyTbButton', array(
            'label' => 'Download',
            'url' => array('view', 'id' =>  $model->Main_Class_Id , 'export' => 'PDF'),
            'buttonType' => 'link',
            'context' => 'warning',
                )
        );
