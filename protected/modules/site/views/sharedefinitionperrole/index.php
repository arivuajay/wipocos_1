...
<div class="col-lg-12 col-md-12">
    <div class="row mb10">
        ...
        $this->widget(
            ...
            'label' => 'Create ShareDefinitionPerRole',
            'icon' => 'fa fa-plus',
            'url' => array('/site/sharedefinitionperrole/create'),
            'buttonType' => 'link',
            'context' => 'success',
...
//              'type' => 'raw',
        ...
        $this->widget('booster.widgets.TbExtendedGridView', array(
            ...
            'responsiveTable' => true,
            'template' => '<div class="panel panel-primary"><div class="panel-heading"><div class="pull-right">{summary}</div><h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>  Share Definition Per Roles</h3></div><div class="panel-body">{items}{pager}</div></div>',
            'columns' => $gridColumns
                )
        );
        ?>
