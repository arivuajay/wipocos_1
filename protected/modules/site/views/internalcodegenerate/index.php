...
$this->title='Internalcode Generates';
$this->breadcrumbs=array(
	'Internalcode Generates',
);
	...
	'method'=>'get',
        ...
        'htmlOptions' => array('role' => 'form')
                        ...
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($searchModel,'Gen_User_Type',array('class'=>'form-control','size'=>2,'maxlength'=>2)); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo $form->error($searchModel,'Gen_Inter_Code'); ?>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel,'Gen_Suffix',  array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel,'Gen_Suffix',array('class'=>'form-control','size'=>10,'maxlength'=>10)); ?>
                            <?php echo $form->error($searchModel,'Gen_Suffix'); ?>
                        </div>
                    </div>
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel,'Gen_Code_Pad',  array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel,'Gen_Code_Pad',array('class'=>'form-control')); ?>
                            <?php echo $form->error($searchModel,'Gen_Code_Pad'); ?>
                        </div>
                    </div>
...
<?php
		...
		array(
            ...
            'responsiveTable' => true,
            'template' => '<div class="panel panel-primary"><div class="panel-heading"><div class="pull-right">{summary}</div><h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>  Internalcode Generates</h3></div><div class="panel-body">{items}{pager}</div></div>',
            'columns' => $gridColumns
                )
        );
        ?>
