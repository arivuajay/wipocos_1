...
<div class="row">
	...
	'enableAjaxValidation'=>true,
            ...
            <div class="box-body">
                        ...
                        <?php echo $form->labelEx($model,'Medium_Name',  array('class' => 'col-sm-2 control-label')); ?>
                        <div class="col-sm-5">
                        <?php echo $form->textField($model,'Medium_Name',array('class'=>'form-control','size'=>60,'maxlength'=>100)); ?>
                        ...
                        <?php echo $form->error($model,'Created_By'); ?>
                                        ...
                                        <div class="form-group">
                        <?php echo $form->labelEx($model,'Updated_By',  array('class' => 'col-sm-2 control-label')); ?>
                        <div class="col-sm-5">
