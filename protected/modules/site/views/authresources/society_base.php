        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Master_Soceity_ID') ?>
                    <?php $names = Myclass::getSociety(); ?>
                    <?php
                    echo $form->dropDownList($model, 'Master_Society_ID', $names, array(
                        'prompt' => 'Choose Society',
                        'class' => 'form-control',
                        'onchange' => '{'
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    echo $form->dropDownList($model, 'Master_Module_ID', $modules, array(
                        ...
                        'class' => 'form-control',
                        'onchange' => '{'
                        . 'if($("#AuthResources_Master_Society_ID").val() != "" && this.value != ""){'
                        . '$("#ajax-loader").show();'
                        . '$("#resources-block").hide();'
                        . '$.get("' . Yii::app()->createUrl("site/authresources/getscreensbymodule") . '", { 
                            type: "society", 
                            mid: this.value, 
                            id: $("#AuthResources_Master_Society_ID").val() }
                            ).done(function( data ){
                                $("#ajax-loader").hide();
