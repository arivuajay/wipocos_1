    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box box-primary">
            ...
            $form = $this->beginWidget('CActiveForm', array(
                'id' => 'master-pseudonym-types-form',
            ...
            <div class="box-body">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Pseudo_Code', array('class' => 'col-sm-2 control-label')); ?>
                    <div class="col-sm-5">
                        <?php echo $form->textField($model, 'Pseudo_Code', array('class' => 'form-control', 'size' => 5, 'maxlength' => 5)); ?>
                        <?php echo $form->error($model, 'Pseudo_Code'); ?>
                    </div>
                </div>
