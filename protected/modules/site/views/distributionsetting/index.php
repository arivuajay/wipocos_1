...
$this->title='Distribution Settings';
	...
	'method'=>'get',
        ...
        'htmlOptions' => array('role' => 'form')
                        ...
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($searchModel,'Setting_Date',array('class'=>'form-control')); ?>
                        </div>
                    </div>
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
...
<div class="col-lg-12 col-md-12">
    <div class="row">
        ...
        <?php        $this->widget(
            ...
            'label' => 'Create DistributionSetting',
            'icon' => 'fa fa-plus',
...
<?php
		...
		array(
            ...
            'responsiveTable' => true,
            'template' => '<div class="panel panel-primary"><div class="panel-heading"><div class="pull-right">{summary}</div><h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>  Distribution Settings</h3></div><div class="panel-body">{items}{pager}</div></div>',
            'columns' => $gridColumns
                )
        );
        ?>
