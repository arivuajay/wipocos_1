...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pro_Pseudo_Name', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pro_Pseudo_Type_Id', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
