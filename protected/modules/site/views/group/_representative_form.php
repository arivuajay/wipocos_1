    ...
    <div class="col-lg-5">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'Group_Rep_Address_1', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
            </div>

            <div class="form-group">
                <?php echo $form->textField($model, 'Group_Rep_Address_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Rep_Address_2'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->textField($model, 'Group_Rep_Address_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Rep_Address_3'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->textField($model, 'Group_Rep_Address_4', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
            ...
            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Home_Address_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Home_Address_2'); ?>
            </div>

            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Home_Address_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Home_Address_3'); ?>
            </div>

            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Home_Address_4', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
            ...
            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Mailing_Address_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Mailing_Address_2'); ?>
            </div>

            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Mailing_Address_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                <?php echo $form->error($model, 'Group_Mailing_Address_3'); ?>
            </div>

            <div class="form-group hide">
                <?php echo $form->textField($model, 'Group_Mailing_Address_4', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
    ...
    <div class="col-lg-5">
        <div class="box-body">
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'Group_Home_Telephone', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                <?php echo $form->error($model, 'Group_Home_Telephone'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Home_Email', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Home_Email', array('class' => 'form-control addr-input', 'size' => 50, 'maxlength' => 50)); ?>
                <?php echo $form->error($model, 'Group_Home_Email'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Home_Website', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Home_Website', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 100)); ?>
                <?php echo $form->error($model, 'Group_Home_Website'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Home_Fax', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Home_Fax', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                <?php echo $form->error($model, 'Group_Home_Fax'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mailing_Telephone', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Mailing_Telephone', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                <?php echo $form->error($model, 'Group_Mailing_Telephone'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mailing_Fax', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Mailing_Fax', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                <?php echo $form->error($model, 'Group_Mailing_Fax'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mailing_Email', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Mailing_Email', array('class' => 'form-control addr-input', 'size' => 50, 'maxlength' => 50)); ?>
                <?php echo $form->error($model, 'Group_Mailing_Email'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mailing_Website', array('class' => '')); ?>
                <?php echo $form->textField($model, 'Group_Mailing_Website', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 100)); ?>
...
<?php
$js = <<< EOD
    unknown = '{$model->Group_Unknown_Address}';
