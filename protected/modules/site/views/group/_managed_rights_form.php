    ...
    <div class="col-lg-5 col-xs-5">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Group_Mnge_Society_Id', $societies, array('class' => 'form-control', 'prompt' => '')); ?>
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Group_Mnge_Internal_Position_Id', $internal_positions, array('class' => 'form-control', 'prompt' => '')); ?>
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'Group_Mnge_Exit_Date_2', array('class' => 'form-control date', 'value' => isset($model->Group_Mnge_Exit_Date_2) ? $model->Group_Mnge_Exit_Date_2 : date('Y-m-d'))); ?>
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'Group_Mnge_Avl_Work_Cat_Id', $work_categories, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Group_Mnge_Avl_Work_Cat_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mnge_Type_Rght_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Group_Mnge_Type_Rght_Id', $right_types, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Group_Mnge_Type_Rght_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mnge_Managed_Rights_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Group_Mnge_Managed_Rights_Id', $managed_rights, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Group_Mnge_Managed_Rights_Id'); ?>
            </div>

            <div class="form-group">
                <?php echo $form->labelEx($model, 'Group_Mnge_Territories_Id', array('class' => '')); ?>
                <?php echo $form->dropDownList($model, 'Group_Mnge_Territories_Id', $territories, array('class' => 'form-control', 'prompt' => '')); ?>
