...
<div class="box box-primary">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'publisher-group-pseudonym-form',
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pub_Group_Pseudo_Type_Id', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php $psedonyms = Myclass::getMasterPseudonym(); ?>
                <?php echo $form->dropDownList($model, 'Pub_Group_Pseudo_Type_Id', $psedonyms, array('class' => 'form-control', 'prompt' => '')); ?>
                <?php echo $form->error($model, 'Pub_Group_Pseudo_Type_Id'); ?>
            </div>
        </div>

        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pub_Group_Pseudo_Name', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php echo $form->textField($model, 'Pub_Group_Pseudo_Name', array('class' => 'form-control', 'size' => 50, 'maxlength' => 50)); ?>
                <?php echo $form->error($model, 'Pub_Group_Pseudo_Name'); ?>
            </div>
        </div>
