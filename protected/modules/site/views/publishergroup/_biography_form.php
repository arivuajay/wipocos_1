<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <?php
                $max_size = PublisherGroupBiographUploads::IMAGE_SIZE;
                $this->widget('CMultiFileUpload', array(
                    'model' => $biograph_upload_model,
                    'name' => 'Pub_Group_Biogrph_Upl_File',
                    'accept' => PublisherGroupBiographUploads::ACCESS_TYPES_WID,
        ...
        <div class="form-group">
            <?php echo $form->labelEx($biograph_upload_model, 'Pub_Group_Biogrph_Upl_Description', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
                <?php echo $form->textArea($biograph_upload_model, 'Pub_Group_Biogrph_Upl_Description', array('class' => 'form-control', 'rows' => 6, 'cols' => 50)); ?>
                <?php echo $form->error($biograph_upload_model, 'Pub_Group_Biogrph_Upl_Description'); ?>
            </div>
        </div>
    </div><!-- /.box-body -->
