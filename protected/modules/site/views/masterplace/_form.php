        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Place_Code', array('class' => 'col-sm-2 control-label')); ?>
                    <div class="col-sm-5">
                        <?php echo $form->textField($model, 'Place_Code', array('class' => 'form-control', 'size' => 50, 'maxlength' => 50)); ?>
                        <?php echo $form->error($model, 'Place_Code'); ?>
                    </div>
                </div>

                <div class="form-group">
                    <?php echo $form->labelEx($model, 'Place_Name', array('class' => 'col-sm-2 control-label')); ?>
                    <div class="col-sm-5">
