        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo CHtml::label($model->getAttributeLabel('Pub_Head_Address_1').' *', 'PublisherAccountAddress_Pub_Head_Address_1', array('class' => 'col-sm-4 control-label')); ?> 
                    <div class="col-sm-8">
                        <?php echo $form->textArea($model, 'Pub_Head_Address_1', array('class' => 'form-control addr-input', 'rows' => '5')); ?>
                ...
                <div class="form-group hide">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Address_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <div class="form-group hide">
                    <?php echo CHtml::label('&nbsp;', '', array('class' => 'col-sm-4 control-label')); ?>
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Address_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <div class="form-group">
                    <?php echo CHtml::label($model->getAttributeLabel('Pub_Mailing_Address_1'), 'PublisherAccountAddress_Pub_Mailing_Address_1', array('class' => 'col-sm-4 control-label')); ?> 
                    <?php // echo $form->labelEx($model, 'Pub_Mailing_Address_1', array('class' => 'col-sm-4 control-label')); ?>
                    <div class="col-sm-8">
                        <?php echo $form->textArea($model, 'Pub_Mailing_Address_1', array('class' => 'form-control addr-input', 'rows' => '5')); ?>
                ...
                <div class="form-group hide">
                    <?php echo CHtml::label('&nbsp;', '', array('class' => 'col-sm-4 control-label')); ?>
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Address_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <div class="form-group hide">
                    <?php echo CHtml::label('&nbsp;', '', array('class' => 'col-sm-4 control-label')); ?>
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Address_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Publisher_Account_1', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Publisher_Account_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Publisher_Account_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Telephone', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Email', array('class' => 'form-control addr-input', 'size' => 50, 'maxlength' => 50)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Website', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 100)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Head_Fax', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Telephone', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Fax', array('class' => 'form-control addr-input', 'size' => 25, 'maxlength' => 25)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Email', array('class' => 'form-control addr-input', 'size' => 50, 'maxlength' => 50)); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php echo $form->textField($model, 'Pub_Mailing_Website', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 100)); ?>
                        <?php echo $form->error($model, 'Pub_Mailing_Website'); ?>
                    </div>
                </div>

                <div class="form-group">
                    <?php echo CHtml::label($model->getAttributeLabel('Pub_Addr_Country_Id').' *', 'PublisherAccountAddress_Pub_Addr_Country_Id', array('class' => 'col-sm-4 control-label')); ?> 
                    <?php // echo $form->labelEx($model, 'Pub_Addr_Country_Id', array('class' => 'col-sm-4 control-label')); ?>
                    <div class="col-sm-8">
                        <?php echo $form->dropDownList($model, 'Pub_Addr_Country_Id', $countries, array('class' => 'form-control addr-input', 'prompt' => '')); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Producer_Account_1', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Producer_Account_2', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
                ...
                <?php echo $form->textField($model, 'Pub_Producer_Account_3', array('class' => 'form-control addr-input', 'size' => 60, 'maxlength' => 255)); ?>
...
<?php
$js = <<< EOD
    unknown = '{$model->Pub_Unknown_Address}';
    $(document).ready(function(){
        $('#PublisherAccountAddress_Pub_Unknown_Address').on('ifChecked', function(event){
            $('.addr-input').attr("readonly", true);
        });

        $('#PublisherAccountAddress_Pub_Unknown_Address').on('ifUnchecked', function(event){
