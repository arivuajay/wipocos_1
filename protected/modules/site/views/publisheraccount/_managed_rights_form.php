                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        echo CHtml::dropDownList('Pub_Mnge_Managed_Rights_Source', array(), $remain_manages, array('class' => 'form-control', 'multiple' => true, 'id' => 'select-mged-from', 'size' => 7));
                                        ...
                                        echo CHtml::dropDownList('Pub_Mnge_Managed_Rights_Destination', array(), $selected_manages, array('class' => 'form-control', 'multiple' => true, 'id' => 'select-mged-to', 'size' => 7));
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        echo '<div class="col-sm-5">';
                                        echo CHtml::dropDownList('Pub_Mnge_Territories_Source', array(), $remain_terr, array('class' => 'form-control', 'multiple' => true, 'id' => 'select-terr-from', 'size' => 7));
                                        ...
                                        echo CHtml::dropDownList('Pub_Mnge_Territories_Destination', array(), $selected_terr, array('class' => 'form-control', 'multiple' => true, 'id' => 'select-terr-to', 'size' => 7));
