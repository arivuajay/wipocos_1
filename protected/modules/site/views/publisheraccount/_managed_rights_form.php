    ...
    <div class="col-lg-5 col-xs-5">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <?php echo $form->textField($model, 'Pub_Mnge_Exit_Date_2', array('class' => 'form-control date', 'value' => isset($model->Pub_Mnge_Exit_Date_2) ? $model->Pub_Mnge_Exit_Date_2 : date('Y-m-d'))); ?>
