<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pub_Suc_Address_1', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pub_Suc_Address_2', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'Pub_Suc_Annotation', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-5">
