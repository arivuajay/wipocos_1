        ...
        'htmlOptions' => array('role' => 'form')
                        ...
                        <div class="form-group">
                            ...
                            <?php echo $form->error($searchModel,'Insp_Internal_Code'); ?>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <?php echo $form->labelEx($searchModel,'Insp_GUID',  array('class' => ' control-label')); ?>
                            <?php echo $form->textField($searchModel,'Insp_GUID',array('class'=>'form-control','size'=>40,'maxlength'=>40)); ?>
                            <?php echo $form->error($searchModel,'Insp_GUID'); ?>
                        </div>
                    </div>
                                        <div class="col-lg-4 col-md-4">
                        <div class="form-group">
