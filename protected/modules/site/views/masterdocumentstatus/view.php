...
$this->title = 'View Master Document Status: ' . $model->Document_Sts_Name;
    ...
    <p>
        ...
        $this->widget(
                'application.components.MyActionButton', array(
                    'label' => 'Update',
                    'url' => array('update', 'id' => $model->Master_Document_Sts_Id),
                    'buttonType' => 'link',
                    'context' => 'primary',
//                    
                )
        ...
        $this->widget(
                'application.components.MyTbButton', array(
                    'label' => 'Delete',
                    'url' => array('delete', 'id' => $model->Master_Document_Sts_Id),
                    'buttonType' => 'link',
                    'context' => 'danger',
