...
<div class="user-create">
    <?php $this->renderPartial('_form', compact('model', 'document_model', 'tab', 'biograph_model', 'biograph_upload_model', 'sub_title_model', 'publication_model', 'fixation_model')); ?></div>