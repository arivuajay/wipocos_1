...
{if $SHOW_HIDE_PREPARE_PAGE_STYLE == "show"}
			<div style="width: 20%; padding: 15px 0; float: left;vertical-align: bottom;text-align: center">
{else}
			<div style="display:none; width: 20%; padding: 15px 0;float: left;vertical-align: bottom;text-align: center">
{/if}
                <b>{$T_REPORT_STYLE}</b>
			...
			<div class="swPrpToolbarPane" style="width: 50%; float: left; vertical-align: bottom;text-align: right; margin-top: 10px;">
{if $SHOW_DESIGN_BUTTON}
...
{if $SHOW_HIDE_PREPARE_CSV_BUTTON == "show"}
    <BUTTON type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swCSVBox btn btn-app" title="{$T_PRINT_CSV}" id="prepareAjaxExecute" name="submitPrepare" >
...
{else}
    <BUTTON style="display:none" type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swCSVBox btn btn-app" title="{$T_PRINT_CSV}" id="prepareAjaxExecute" name="submitPrepare" >
                                        <i class="fa fa-file-excel-o"></i> CSV
                                    </BUTTON>
...
{if $SHOW_HIDE_PREPARE_PDF_BUTTON == "show"}
                                <BUTTON type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swPDFBox btn btn-app" title="{$T_PRINT_PDF}" id="prepareAjaxExecute" name="submitPrepare">
...
{else}
                                <BUTTON style="display:none" type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swPDFBox btn btn-app" title="{$T_PRINT_PDF}" id="prepareAjaxExecute" name="submitPrepare">
                                        <i class="fa fa-file-pdf-o"></i> PDF
                                    </BUTTON>
...
{if $SHOW_HIDE_PREPARE_HTML_BUTTON == "show"}
                                <BUTTON type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swHTMLBox btn btn-app" title="{$T_PRINT_HTML}" id="prepareAjaxExecute" name="submitPrepare">
...
{else}
                                <BUTTON style="display:none" type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swHTMLBox btn btn-app" title="{$T_PRINT_HTML}" id="prepareAjaxExecute" name="submitPrepare">
                                        <i class="fa fa-list-alt"></i> View
                                    </BUTTON>
...
{if $SHOW_HIDE_PREPARE_PRINT_HTML_BUTTON == "show"}
                                    <BUTTON type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swPrintBox btn btn-app" title="{$T_PRINTABLE}" id="prepareAjaxExecute" name="submitPrepare">
...
{else}
                                    <BUTTON style="display:none" type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareAjaxExecute swPrintBox btn btn-app" title="{$T_PRINTABLE}" id="prepareAjaxExecute" name="submitPrepare">
                                        <i class="fa fa-print"></i> Print
                                    </BUTTON>
...
{if $SHOW_HIDE_PREPARE_SECTION_BOXES == "show"}
			<div style="width: 30%; padding-top: 15px;float: left;vertical-align: bottom;text-align: center">
{else}
			<div style="display:none; width: 30%; padding-top: 15px;float: left;vertical-align: bottom;text-align: center">
{/if}
                                  <b>{$T_SHOW}</b>
