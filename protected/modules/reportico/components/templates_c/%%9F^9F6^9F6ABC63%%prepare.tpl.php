<?php /* Smarty version 2.6.26, created on 2015-11-30 15:23:35
...
<?php if ($this->_tpl_vars['SHOW_HIDE_PREPARE_CSV_BUTTON'] == 'show'): ?>
    <BUTTON type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swCSVBox btn btn-app" title="<?php echo $this->_tpl_vars['T_PRINT_CSV']; ?>
" id="prepareAjaxExecute" name="submitPrepare" >
                                        <i class="fa fa-file-excel-o"></i> CSV
                                    </BUTTON>
<?php else: ?>
    <BUTTON style="display:none" type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swCSVBox btn btn-app" title="<?php echo $this->_tpl_vars['T_PRINT_CSV']; ?>
" id="prepareAjaxExecute" name="submitPrepare" >
                                        <i class="fa fa-file-excel-o"></i> CSV
                                    </BUTTON>
...
<?php if ($this->_tpl_vars['SHOW_HIDE_PREPARE_PDF_BUTTON'] == 'show'): ?>
                                <BUTTON type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swPDFBox btn btn-app" title="<?php echo $this->_tpl_vars['T_PRINT_PDF']; ?>
" id="prepareAjaxExecute" name="submitPrepare">
...
<?php if ($this->_tpl_vars['SHOW_HIDE_PREPARE_HTML_BUTTON'] == 'show'): ?>
                                <BUTTON type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swHTMLBox btn btn-app" title="<?php echo $this->_tpl_vars['T_PRINT_HTML']; ?>
" id="prepareAjaxExecute" name="submitPrepare">
...
<?php if ($this->_tpl_vars['SHOW_HIDE_PREPARE_PRINT_HTML_BUTTON'] == 'show'): ?>
                                    <BUTTON type="submit" class="<?php echo $this->_tpl_vars['BOOTSTRAP_STYLE_TOOLBAR_BUTTON']; ?>
prepareAjaxExecute swPrintBox btn btn-app" title="<?php echo $this->_tpl_vars['T_PRINTABLE']; ?>
" id="prepareAjaxExecute" name="submitPrepare">
